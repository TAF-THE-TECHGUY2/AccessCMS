            ...
            sections: [
                        ...
                        items: [
                            {
                                ...
                                iconName: "Lightbulb",
                                title: "Our Story",
                                content: "Our story began with a simple belief: real estate investment should be accessible to everyone. This drives our mission to democratize property investing through innovation, transparency, and inclusion. With minimum investments starting at just $100, our digital platform empowers individuals to participate in markets once reserved for institutions and the wealthy.",
                            },
                            {
                                id: "mission",
                                iconName: "Shield",
                                title: "Our Mission",
                                content: "Real estate continues to create immense wealth yet the vast majority remain locked out. Faced with that inequity, we turned our passion into an opportunity. Founded in November 2022, Access Properties is a mission-driven real estate syndication and investment technology startup committed to creating value through strategic property investments.",
                            },
                        ],
                    },
                },
                {
                    ...
                    data: {
                        ...
                        subtitle: "We prioritize compliance, transparency, and secure operations so investors can participate with confidence.",
                        background: "gray",
                        items: [
                        ...
                        items: [
                            {
                                ...
                                content: "Real estate historically strengthens portfolios by balancing exposure between stocks and bonds, reducing overall risk.",
                            },
                            {
                                id: "income",
                                iconName: "Coins",
                                title: "Income",
                                content: "Real estate has consistently delivered higher yields than traditional fixed-income investments, even in inflationary periods.",
                            },
                            {
                                id: "growth",
                                iconName: "TrendingUp",
                                title: "Growth Potential",
                                content: "Over time, real estate appreciates faster than inflation, supporting wealth preservation and long-term capital growth.",
                            },
                            {
                                id: "stability",
                                iconName: "Lock",
                                title: "Stability",
                                content: "Real estate values typically fluctuate less than other assets, providing stability within a diversified investment portfolio.",
                            },
                        ],
                    },
                },
                        ...
                        items: [
                            {
                                ...
                                content: "Real estate investments are typically reserved for institutional investors, with minimums often ranging from $50,000 to $250,000. We're changing that dynamic. Accredited investors can start with $10,000, while crowdfunders can participate with as little as $100. By lowering investment thresholds, Access Properties makes real estate more accessible to a broader community of investors.",
                            },
                            {
                                id: "safer",
                                iconName: "ShieldCheck",
                                title: "A Safer Approach",
                                content: "Rather than purchasing a single property or piecing together a portfolio independently, our members have the option to invest in diversified real estate portfolios with carefully selected assets. This approach minimizes risk and offers more consistent returns, providing greater security for investors over time.",
                            },
                            {
                                id: "philosophy",
                                iconName: "Lightbulb",
                                title: "Investment Philosophy",
                                content: "Our investment approach is rooted in rigorous criteria: resilient locations, value-add potential, and downside protection. We pursue a variety of strategies, including Buy & Hold for steady income, BRRR (Buy, Renovate, Rent & Refinance) for capital recycling, and Fix & Flip for short-term gains. Each opportunity undergoes detailed financial analysis to meet our strict benchmarks.",
                            },
                            {
                                id: "management",
                                iconName: "BarChart3",
                                title: "Active Portfolio Management",
                                content: "Our team is composed of licensed investment advisors and real estate agents with extensive local expertise. From acquisition to management and eventual exit, we oversee every detail, ensuring that our members enjoy steady, passive returns. Regular updates keep investors informed and confident in their portfolios.",
                            },
                            {
                                id: "value",
                                iconName: "Wrench",
                                title: "Unlocking Value",
                                content: "Our strategy revolves around value-driven investments. We target properties with high potential, adding value through strategic improvements or repositioning. This enhances both the local community and investor returns by revitalizing underperforming assets and driving economic growth.",
                            },
                            {
                                id: "integrated",
                                iconName: "Link2",
                                title: "Integrated Model",
                                content: "Part of Access Group, we leverage cost-effective property improvement advisory services, maximizing the impact of every dollar invested. This allows more capital to flow directly into the assets themselves, which enhances overall investment returns for our members.",
                            },
                        ],
                    },
                },
                {
                    ...
                    data: {
                        ...
                        items: [
                            ...
                            {
                                quote: "I'm an active investor in the public markets and startups, and after seeing the progress Access Properties had made and knowing the founder personally I felt comfortable joining at this point to support the next phase of the company's growth.",
            ...
            sections: [
                ...
                },
                {
                    ...
                    data: {
                        ...
                        subtitle: "We remove long-standing barriers to property investing so more people can participate with clarity and confidence. Our platform gives members access to professionally managed portfolios through a streamlined digital experience.",
                        items: [
                            {
                                id: "changing-digital",
                                iconName: "Sparkles",
                                title: "Digital Syndication & Automated Investment",
                                content: "Our proprietary technology powers a digital syndication model that connects crowdfunding participants and accredited investors within unified investment structures. From onboarding to reporting, every stage is designed to be simple, transparent, and automated.",
                            },
                            {
                                id: "changing-asset",
                                iconName: "BarChart3",
                                title: "Asset Management & Portfolio Growth",
                                content: "We actively manage each portfolio through disciplined underwriting, operating improvements, and strategic execution to pursue long-term value creation and consistent performance.",
                            },
                        ],
                    },
                },
                        ...
                        items: [
                            {
                                ...
                                iconName: "Briefcase",
                                title: "Our Expertise",
                                content: "To deliver exceptional outcomes, Access Properties leverages deep industry knowledge, comprehensive market research, and rigorous financial analysis. Strengthened by strategic partnerships, our team works to optimize asset performance at every stage.",
                            },
                            {
                                id: "story-approach",
                                iconName: "Building2",
                                title: "Our Approach",
                                content: "Access Properties pools member capital to build diversified real estate portfolios across multiple geographies. By identifying, acquiring, improving, and managing high-potential assets, we create opportunities for broad participation in markets traditionally dominated by institutions.",
                            },
                        ],
                    },
                },
                        ...
                        cards: [
                            {
                                ...
                                interviewSnippets: [
                                    ...
                                    },
                                    {
                                        ...
                                        description: "A segment focused on where the company is headed and how investors fit into that future.",
                                        audioSrc: "",
                                        startTime: 106,
                                        endTime: 170,
                ...
                },
                {
                    ...
                    data: {
                        ...
                        body: "We're supported by four additional managing partners who bring deep expertise across banking, finance, law, and construction. Beyond their seed investment, they actively contribute strategic insight and operational guidance, strengthening our foundation as we scale.",
                    },
                },
                { type: "DISCLOSURE", data: {} },
                { type: "SOCIALS", data: {} },
            ...
            sections: [
                ...
                },
                {
                    ...
                    data: {
                        ...
                        imageUrl: "https://images.unsplash.com/photo-1444723121867-7a241cacace9?auto=format&fit=crop&w=2400&q=80",
                        reasons: [
            ...
            sections: [
                ...
                },
                {
                    ...
                    data: {
                        ...
                        bodyHtml: "<p>This website and its content are provided for informational purposes only. Nothing herein constitutes an offer to sell, or a solicitation of an offer to buy, any securities or investment products.</p>" +
        ...
        },
        {
            ...
            sections: [
                ...
                },
                {
                    ...
                    data: {
                        heading: "Overview",
                        bodyHtml: "<p>This policy explains how we collect, use, and protect your personal information.</p>",
                    },
                },
                { type: "DISCLOSURE", data: {} },
                { type: "SOCIALS", data: {} },
    ...
    await FAQ.insertMany([
        {
            ...
            answerHtml: "<p>Access Properties is a private real estate investment platform that allows investors to participate in professionally managed, diversified real estate portfolios with low minimum investments. We focus on acquiring, renovating, and managing properties in the Greater Boston area.</p>",
            category: "Legal",
            order: 1,
        },
        {
            question: "Who can invest with Access Properties?",
            answerHtml: "<p>Both accredited investors and non-accredited investors (crowdfunders) can invest, subject to applicable regulations and offering terms. Accredited investors typically have higher investment minimums, while crowdfunding allows participation starting at $100.</p>",
            category: "Legal",
            order: 2,
        },
        {
            question: "Who owns the properties?",
            answerHtml: "<p>Each property is owned by Access Properties LLC. By investing in Access Properties, you acquire an indirect fractional ownership interest in a managed, diversified real estate portfolio. You do not directly own individual properties.</p>",
            category: "Legal",
            order: 3,
        },
        {
            question: "What legal structure does Access Properties use?",
            answerHtml: "<p>Access Properties operates as a Limited Liability Company (LLC). Investors become members of the LLC and receive membership interests proportional to their investment. This structure provides liability protection and favorable tax treatment.</p>",
            category: "Legal",
            order: 4,
        },
        {
            question: "Are investments guaranteed?",
            answerHtml: "<p>No investment is guaranteed. Real estate investments involve risk, including the potential loss of principal. Market conditions, property performance, and economic factors can all impact returns. Past performance is not indicative of future results.</p>",
            category: "Legal",
            order: 5,
        },
        {
            question: "Where can I find full legal disclosures?",
            answerHtml: "<p>Full legal disclosures, including the Private Placement Memorandum (PPM), Operating Agreement, and all material risk factors are available within each portfolio's offering documents on the platform. We recommend reviewing these carefully before investing.</p>",
            category: "Legal",
            order: 6,
        },
        {
            question: "What are my rights as an investor?",
            answerHtml: "<p>As a member of the LLC, you have the right to receive distributions according to your ownership percentage, review annual financial statements, vote on major decisions as outlined in the Operating Agreement, and access regular property updates and performance reports.</p>",
            category: "Legal",
            order: 7,
        },
        {
            question: "Can I sell my investment?",
            answerHtml: "<p>Investments in Access Properties are generally illiquid and intended for long-term holding. While transfers may be possible under certain conditions and with company approval, there is no established secondary market. Exit opportunities typically occur upon property sales or refinancing events.</p>",
            category: "Legal",
            order: 8,
        },
        {
            question: "How does Access Properties select investments?",
            answerHtml: "<p>We focus on undervalued properties in strong Greater Boston markets with appreciation potential. Our selection criteria include location quality, renovation opportunities, rental demand, and alignment with our investment strategies (Buy & Hold, BRRR, or Fix & Flip).</p>",
            category: "Operational",
            order: 1,
        },
        {
            question: "What investment strategies does Access Properties employ?",
            answerHtml: "<p>Access Properties uses three primary strategies:</p><ul><li><strong>Buy &amp; Hold:</strong> Acquire stable properties for long-term rental income</li><li><strong>BRRR (Buy, Renovate, Rent, Refinance):</strong> Add value through renovations, stabilize with tenants, then refinance</li><li><strong>Fix &amp; Flip:</strong> Purchase distressed properties, renovate, and sell for profit</li></ul>",
            category: "Operational",
            order: 2,
        },
        {
            question: "Who manages the properties?",
            answerHtml: "<p>Properties are professionally managed by Access Properties' experienced team. We handle all aspects including tenant screening, rent collection, maintenance coordination, renovations, and regulatory compliance. Investors receive regular updates but are not involved in day-to-day operations.</p>",
            category: "Operational",
            order: 3,
        },
        {
            question: "How often will I receive updates on my investment?",
            answerHtml: "<p>Investors receive quarterly performance reports detailing property operations, financial performance, occupancy rates, and any significant developments. Major updates such as completed renovations, refinancing events, or property sales are communicated as they occur.</p>",
            category: "Operational",
            order: 4,
        },
        {
            question: "What happens if a property needs major repairs?",
            answerHtml: "<p>We maintain reserve funds for capital expenditures and unexpected repairs. Major repairs are budgeted into our initial underwriting. If extraordinary expenses exceed reserves, the company may defer distributions temporarily or, in rare cases, conduct a capital call from members.</p>",
            category: "Operational",
            order: 5,
        },
        {
            question: "How does Access Properties handle tenant issues?",
            answerHtml: "<p>Our property management team handles all tenant-related matters including lease enforcement, maintenance requests, conflict resolution, and if necessary, eviction proceedings. We maintain 24/7 emergency maintenance support and work to keep occupancy rates high through responsive service.</p>",
            category: "Operational",
            order: 6,
        },
        {
            question: "What insurance coverage is maintained?",
            answerHtml: "<p>All properties carry comprehensive insurance including property/casualty coverage, liability protection, and loss of rents coverage. The LLC also maintains general liability insurance. Insurance costs are factored into operating expenses and reflected in financial projections.</p>",
            category: "Operational",
            order: 7,
        },
        {
            question: "Can I visit the properties I've invested in?",
            answerHtml: "<p>Due to privacy concerns for tenants and operational considerations, property visits are generally not permitted for occupied units. However, we provide comprehensive photo documentation, virtual tours, and detailed progress reports for all properties in the portfolio.</p>",
            category: "Operational",
            order: 8,
        },
        {
            question: "What tax documents will I receive?",
            answerHtml: "<p>As an LLC member, you will receive a Schedule K-1 annually by March 15th (or extension date). The K-1 reports your proportionate share of the LLC's income, losses, deductions, and credits. You'll use this to complete your personal tax return.</p>",
            category: "Tax",
            order: 1,
        },
        {
            question: "How is rental income taxed?",
            answerHtml: "<p>Rental income flows through to you as passive income reported on your Schedule K-1. This income is offset by property expenses including depreciation, mortgage interest, property taxes, insurance, maintenance, and management fees. Most investors see tax losses in early years due to depreciation deductions.</p>",
            category: "Tax",
            order: 2,
        },
        {
            question: "What is depreciation and how does it benefit me?",
            answerHtml: "<p>Depreciation is a non-cash deduction that reduces taxable income. Residential rental properties are depreciated over 27.5 years. For example, a $275,000 building generates approximately $10,000 in annual depreciation deductions, reducing your taxable income even while the property may be appreciating in value.</p>",
            category: "Tax",
            order: 3,
        },
        {
            question: "Can I deduct losses from my investment?",
            answerHtml: "<p>Passive losses from real estate can generally offset passive income. If you have excess passive losses, they carry forward indefinitely to offset future passive income. Real estate professionals who materially participate may be able to deduct losses against ordinary income. Consult your tax advisor for your specific situation.</p>",
            category: "Tax",
            order: 4,
        },
        {
            question: "What happens tax-wise when a property is sold?",
            answerHtml: "<p>Property sales generate capital gains or losses reported on your K-1. Long-term capital gains (property held over 1 year) receive preferential tax rates. Depreciation recapture is taxed at a maximum 25% rate. In a 1031 exchange, gains can be deferred by reinvesting proceeds into new properties.</p>",
            category: "Tax",
            order: 5,
        },
        {
            question: "Are distributions taxable?",
            answerHtml: "<p>Distributions themselves are generally not taxable events - you're taxed on your share of the LLC's income regardless of whether distributions are made. However, distributions may reduce your tax basis in the investment. If distributions exceed your basis, the excess is treated as capital gain.</p>",
            category: "Tax",
            order: 6,
        },
        {
            question: "Do I need to file taxes in Massachusetts?",
            answerHtml: "<p>If you're not a Massachusetts resident but invest in Access Properties, you may need to file a Massachusetts non-resident tax return reporting your share of income from properties located in Massachusetts. Consult with a tax professional familiar with multi-state tax issues.</p>",
            category: "Tax",
            order: 7,
        },
        {
        ...
        },
        {
            ...
            answerHtml: "<p>Minimum investments vary by offering and investor type. Crowdfunding opportunities start at $100, making real estate accessible to most investors. Accredited investors typically have minimums starting at $10,000 for direct investment opportunities.</p>",
            category: "Financial",
            order: 1,
        },
        {
            question: "How are returns generated?",
            answerHtml: "<p>Returns come from three sources: (1) Rental income distributed periodically to investors, (2) Property appreciation realized when properties are sold or refinanced, and (3) Equity captured through strategic renovations that increase property values and rental rates.</p>",
            category: "Financial",
            order: 2,
        },
        {
            question: "What are the expected returns?",
            answerHtml: "<p>Target returns vary by strategy: Buy &amp; Hold targets 8-12% annual cash-on-cash returns plus appreciation; BRRR targets 12-18% IRR over 3-5 years; Fix &amp; Flip targets 15-25% returns over 6-18 months. Returns are projections only and not guaranteed. Actual performance may vary significantly.</p>",
            category: "Financial",
            order: 3,
        },
        {
            question: "How often are distributions paid?",
            answerHtml: "<p>Distribution schedules vary by property strategy and performance. Buy &amp; Hold properties typically distribute quarterly or annually once stabilized. BRRR properties may defer distributions until refinancing. Fix &amp; Flip investments distribute proceeds upon property sale. All distributions are subject to sufficient cash flow and company discretion.</p>",
            category: "Financial",
            order: 4,
        },
        {
            question: "What fees does Access Properties charge?",
            answerHtml: "<p>Fee structure varies by offering but typically includes:</p><ul><li><strong>Acquisition Fee:</strong> 1-2% of purchase price for sourcing and closing</li><li><strong>Asset Management Fee:</strong> 1-2% annually of invested capital</li><li><strong>Property Management Fee:</strong> 8-10% of collected rents</li><li><strong>Disposition Fee:</strong> 1-2% of sale price when properties are sold</li><li><strong>Performance Fee:</strong> 20% of profits above preferred return hurdle</li></ul><p>All fees are detailed in offering documents.</p>",
            category: "Financial",
            order: 5,
        },
        {
            question: "What is a preferred return?",
            answerHtml: "<p>A preferred return (typically 6-8% annually) means investors receive priority on distributions up to that rate before the sponsor receives performance fees. For example, with an 8% preferred return, investors receive the first 8% of returns, and profits above 8% are split between investors and sponsors (commonly 80/20).</p>",
            category: "Financial",
            order: 6,
        },
        {
            question: "How is property valuation determined?",
            answerHtml: "<p>Initial valuations are based on purchase price and comparable sales. Ongoing valuations use income approaches (capitalization rate applied to net operating income) and sales comparison approaches. Independent appraisals are obtained for refinancing and sales. Annual statements may show estimated values between formal appraisals.</p>",
            category: "Financial",
            order: 7,
        },
        {
            question: "What is the typical hold period?",
            answerHtml: "<p>Hold periods vary by strategy: Buy &amp; Hold properties are held 5-10+ years for long-term appreciation and income; BRRR properties typically 3-5 years through the renovation and stabilization cycle; Fix &amp; Flip properties 6-18 months from acquisition through renovation to sale. Extensions may occur based on market conditions.</p>",
            category: "Financial",
            order: 8,
        },
        {
            question: "What risks should I be aware of?",
            answerHtml: "<p>Real estate investing involves multiple risks including:</p><ul><li><strong>Market Risk:</strong> Property values and rental rates may decline</li><li><strong>Liquidity Risk:</strong> Investments are illiquid with limited exit options</li><li><strong>Operational Risk:</strong> Unexpected repairs, vacancies, or management issues</li><li><strong>Financing Risk:</strong> Interest rate changes or refinancing challenges</li><li><strong>Concentration Risk:</strong> Portfolio focused on Greater Boston market</li><li><strong>Regulatory Risk:</strong> Changes in landlord-tenant laws or zoning</li></ul><p>Review the full risk disclosures in offering documents.</p>",
            category: "Financial",
            order: 9,
        },
        {
            question: "How do I track my investment performance?",
            answerHtml: "<p>Investors receive quarterly reports showing property performance, occupancy, rental income, expenses, and distributions. Annual K-1 tax documents provide comprehensive financial details. You can also access a secure investor portal with real-time property information, documents, and performance dashboards.</p>",
            category: "Financial",
            order: 10,
        },
    ]);
